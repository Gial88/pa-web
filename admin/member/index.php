...
$member = query("SELECT * FROM member WHERE status='Member' ORDER BY id_mem");
...
<head>
    ...
    <title>Admin - Index - Member</title>
    ...
    <main>
        <div class="container">
            ...
            <select class="select-box">
                ...
                <option value="id_mem">ID Member</option>
                <option value="nama_mem">Nama Member</option>
                <option value="nomor_telp_mem">Nomor Telpon</option>
