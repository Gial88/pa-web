	...
	foreach($result as $row){
        $output .='     
            <tr>
                ...
                <td>'.$row["jenis"] .'</td>
                <td>
                    <a class="btn" href="update.php?id='.$row['id_menu'].'">Ubah</a>
                    <a class="btn" href="delete.php?id='.$row['id_menu'].'" onclick="return confirm(\'Apakah Anda ingin menghapus data ?\');">Hapus</a>
                </td>
            </tr>
            ';
        $i++;
